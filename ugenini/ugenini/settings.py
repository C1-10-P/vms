"""
Django settings for ugenini project.
...
SECRET_KEY = 'django-insecure-6=rj^x_hl)i@r4w9cra(wb1)b605u$e3e!f2s=5))_&yyyz1p6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Update this in production to restrict allowed hosts
...
INSTALLED_APPS = [
    ...
    'apps.verify.apps.VerificationConfig',
    'apps.core.apps.CoreConfig',        
    'apps.access.apps.AccessConfig',      
    'apps.users.apps.UsersConfig',       
    'apps.classroom.apps.ClassroomConfig',  
    'apps.vms.apps.VmsConfig',    
    'apps.firmware.apps.FirmwareConfig',     
    'apps.api.apps.ApiConfig',
    'apps.kizaru.apps.KizaruConfig',
...
# Message Tags Mapping (for toastr)
...
MIDDLEWARE = [
    ...
    'apps.users.middleware.RequestLogMiddleware',
    'apps.users.middleware.MaintenanceModeMiddleware',
]

ROOT_URLCONF = 'ugenini.urls'
...
WSGI_APPLICATION = 'ugenini.wsgi.application'
ASGI_APPLICATION = 'ugenini.asgi.application'
...
CELERY_BEAT_SCHEDULE = {
    'check-device-status-every-5-minutes': {
        'task': 'apps.vms.tasks.check_device_status',
